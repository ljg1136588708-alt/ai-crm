...
const en = {
  ...
  dashboard: {
    ...
    noGmailTitle: 'Connect your Gmail to get started',
    noGmailDesc: 'Connect Gmail to build your pipeline automatically',
    readyScan: 'Ready to scan your inbox',
...
const zh: typeof en = {
  ...
  landing: {
    ...
    feature2Title: 'Pipeline 自动驾驶', feature2Desc: '交易随进度自动在 线索→已联系→谈判中→已成交 之间流转。',
  ...
  dashboard: {
    ...
    noGmailTitle: '连接 Gmail 开始使用',
    noGmailDesc: '连接 Gmail 自动构建你的 Pipeline',
    readyScan: '准备扫描收件箱',
    settingUp: '正在初始化账户…',
  ...
  followups: {
    ...
    allCaughtUp: '全部搞定！', draftSubject: 'AI 草稿', clickToExpand: '点击展开',
